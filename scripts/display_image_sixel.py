...
def main():
    parser = argparse.ArgumentParser(description="Display images in Sixel format in the terminal")
    ...
    parser.add_argument("--no-libsixel", action="store_true", help="Don't use libsixel even if available")
    parser.add_argument(
        "--cell-px",
        type=str,
